...
if not os.path.exists(transcript_path):
    print("Error: Transcript file not found at", transcript_path)
    exit(1)
...
if not target_line:
    print("Error: Could not find user input matching 'Dubai CRM' in transcript.")
    exit(1)

try:
    data = json.loads(target_line, strict=False)
...
if not content:
    print("Error: No content key found in JSON object.")
    exit(1)
    ...
    if end_idx != -1:
        ...
        if proj_match:
            ...
            if proj_end != -1:
                ...
                print("Successfully updated projects.js directly!")
            else:
